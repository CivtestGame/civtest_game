...
minetest.register_node("default:sticky_water_source", {
	description = "Sticky Water Source",
	drawtype = "liquid",
	tiles = {
		{
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "default:sticky_water_flowing",
	liquid_alternative_source = "default:sticky_water_source",
	liquid_viscosity = 7,
	post_effect_color = {a = 103, r = 30, g = 60, b = 90},
	groups = {water = 3, liquid = 3, cools_lava = 1},
	sounds = default.node_sound_water_defaults(),
...
minetest.register_node("default:sticky_water_flowing", {
	description = "Flowing Sticky Water",
...
minetest.register_node("default:stronghold_glass", {
	...
	sunlight_propagates = true,
	sounds = default.node_sound_stone_defaults(),
	groups = {cracky = 2, level = 3, not_cuttable = 1},
	node_dig_prediction = "solid_air",
})
...
minetest.register_node("default:stronghold_bricks", {
	...
	groups = {cracky = 1, level = 4, not_cuttable = 1},
	sounds = default.node_sound_metal_defaults(),
})
...
minetest.register_node("default:fortress_glass", {
	...
	sunlight_propagates = true,
	sounds = default.node_sound_stone_defaults(),
	groups = {cracky = 2, level = 4, not_cuttable = 1},
	node_dig_prediction = "solid_air",
})
...
minetest.register_node("default:fortress_bricks", {
	...
	groups = {cracky = 1, level = 5, not_cuttable = 1},
	sounds = default.node_sound_metal_defaults(),
})
